...
setting_control_map = {
    SettingHeading.Main: {
        ...
        "clean_ui_on_drag_drop": SettingControl("remove_old_selection_on_drag_drop","Removes old selection and cleans UI on drag and drop", SettingControlType.Bool, True, "After you drag and drop, previous selected files will be discarded")
    },
